...
<body>
	...
	<div class="container" style="text-align: center;">
		<div
			style='margin-bottom: 50px; text-align: center; display: inline-block; float: center;'>
			<h2 style='margin-top: 80px; margin-bottom: 50px;'>예약정보</h2>
			<div
				style='display: inline-block; float: center; text-align: center; border: 1px solid #000; padding: 55px;'>
				<h4 style='text-align: left; margin-bottom: 10px;'>
					<b>공간명</b> : ${spaceName }
				</h4>
				<h4 style='text-align: left; margin-bottom: 10px;'>
					<b>날짜 </b> : ${sDate }
		...
		<div style='margin-bottom: 80px; text-align: center; display: inline-block; float: center;'>
			...
			<div style='display: inline-block; float: center; text-align: center;'>
				...
				신용카드 <input type="radio" name="paymethod" value="trans"> 실시간
				계좌이체 <input type="radio" name="paymethod" value="kakaopay">
				카카오페이 <br>
				<br>
				<br> <input type="button" value="뒤로가기" onclick="back();"
					class="btn-main"
					style="padding-left: 20px; padding-right: 20px; margin-right: 20px;">
				<input type="button" value="결제하기" onclick="requestPay();"
					class="btn-main" style="padding-left: 20px; padding-right: 20px;">
			</div>
		</div>
	</div>
	<br>
								...
								if (rsp.success) {
									$
											.ajax({
												...
												type : "get",
												data : {
													"reservNo" : rsp.merchant_uid,
													"price" : rsp.paid_amount,
													"paymentDate" : rsp.custom_data.paymentDate,
													"memberName" : rsp.custom_data.memberName,
													"memberPhone" : rsp.custom_data.memberPhone,
													"memberEmail" : rsp.custom_data.memberEmail,
													"spaceNo" : rsp.custom_data.spaceNo,
													"reservDate" : rsp.custom_data.reservDate,
													"revStart" : rsp.custom_data.revStart,
													"revEnd" : rsp.custom_data.revEnd
												},
												success : function(data) {
													location.href = '/space/reservationInfo.kh?reservationNo='
															+ data.reservationNo;
												},
												error : function() {
													alert("통신 실패");
