...
<section class="page-header">
	<div class="container">
		...
		<table align="center" class="table col-10">
			...
			<tr>
			<td  class="col-2" scope="col" align='center' required="required">>지역</td>
			<td>
				<select  name="area">
			...
			<tr>
			<td  class="col-2" scope="col" align='center' required="required">>악기</td>
			<td>
				<input type="text" name="instrument" class="form-control" id="exampleFormControlInput1">
			</td>
			</tr>
			<tr>
