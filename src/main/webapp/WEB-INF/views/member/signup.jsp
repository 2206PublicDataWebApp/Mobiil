    ...
    <div class="signup">
        ...
        <div class="required">
            <form name="email" action="/" method="post">
                <label>이름</label><input type="text" id="input" placeholder="이름을 입력해주세요." required><br>
                ...
                <label>닉네임</label><input type="text" id="input" placeholder="닉네임을 입력해주세요." required><br>
                <label>비밀번호</label><input type="password" id="input" placeholder="문자/숫자/기호 포함하여 6자~20자 입력하세요." required><br>
                <label>비밀번호 확인</label><input type="password" id="input" placeholder="문자/숫자/기호 포함하여 6자~20자 입력하세요." required><br>
                <br>
