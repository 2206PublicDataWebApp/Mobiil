	...
	<div class="container">
		<div id = "mailSender">
			<div class="mb-3">
				  ...
				  <input type="email" class="form-control" id="recipient" name ='recipient' value="${rejectedPartner.memberEmail }" readonly>
				</div>
			<div class="mb-3">
			  	<label for="exampleFormControlInput1" class="form-label">Subject</label>
				  <input type="text" class="form-control" id="subject" name ='subject' value="[파트너 승인 거절]">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				<input type='hidden' id="partnerNo" value='${rejectedPartner.partnerNo }'>
...
<script type="text/javascript">
	...
	function sendRejectMail() {
		...
		if(confirm("전송하시겠습니까?")){
			$.ajax({
				url: "/admin/partnerRejectMail.kh",
				type:"POST",
